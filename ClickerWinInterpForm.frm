object frmClickerWinInterp: TfrmClickerWinInterp
  Left = 387
  Height = 501
  Top = 43
  Width = 893
  ...
  object vstComponents: TVirtualStringTree
    Left = 432
    Height = 256
    Top = 8
    Width = 456
    ...
    OnClick = vstComponentsClick
    OnGetText = vstComponentsGetText
    OnLoadNode = vstComponentsLoadNode
    OnLoadTree = vstComponentsLoadTree
    OnSaveNode = vstComponentsSaveNode
    OnSaveTree = vstComponentsSaveTree
  end
